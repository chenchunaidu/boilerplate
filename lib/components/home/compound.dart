...
import '../../helpers/compound.dart';
import 'alert.dart';

class Compound extends StatelessWidget {
  Compound({Key? key}) : super(key: key);
  ...
  TextEditingController compoundPeriod = TextEditingController();
  @override
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: [
        ...
        ElevatedButton(
            onPressed: () {
              InterestValue result = compoundInterest(startDateInput.text,
